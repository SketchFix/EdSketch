...
public class SketchConditionGenerator_Semmetry extends SketchConditionGenerator {

	public SketchConditionGenerator_Semmetry(SketchExecutor exec) {
		super(exec);
	}
...
//System.out.println(toString());
	...
	private void primeConstruct() {
		...
		lhs = exec.choose(len);
		rhs = exec.choose(len);
		if (lhs>=rhs) SketchRequest.backtrack();
